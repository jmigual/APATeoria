...
| 2016 | Optimal Scheduling of Periodic Gang Tasks                    | Parallel<br>Preemptive<br>Periodic (and sporadic)<br> $J_i \triangleq (r_i, s_i, c_i, d_i)$ <br> $\tau_i \triangleq (s_i, C_i, T_i)$ | :heavy_check_mark: |        :x:         |        :x:         | :heavy_check_mark: | Non-sustainability example |
