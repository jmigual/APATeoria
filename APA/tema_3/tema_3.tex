...
$$
\frac{\partial \ell}{\partial \mu_k} = \sum_{n=1}^N =
...
$$ \frac{\partial N(x, \mu, \Sigma}{\partial \mu} = 
...
$$\frac{\partial z^T A z}{\partial z} = (A + A^T) z \underbrace{=}_{\parbox{3em}{\tiny Si A és simètrica}} 2Az $$
\end{document}