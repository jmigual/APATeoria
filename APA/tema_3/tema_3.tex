...
\begin{flalign*}
	\textbullet &\frac{\partial \ell}{\partial \mu_k} = \sum_{n=1}^N =
...
\begin{flalign*}
	\textbullet\frac{\partial \ell}{\partial \Sigma_k} = 0 \implies 
	\boxed{\Sigma_k = \frac{\sum_{n=1}^N \gamma_k(x_n) (x_n - \mu_k)(x_n - \mu_k)^T}{\sum_{n=1}^N \gamma_k (x_n)}}
	&&
\end{flalign*}

\begin{flalign*}
	\textbullet &\frac{\partial \ell}{\partial \pi_k} \implies 
	\sum_{n=1}^K \pi_k = 1 \implies mcx\ \ell(\theta) + \lambda·\left( \sum_{k=1}^K \pi_k - 1 \right) && \\
